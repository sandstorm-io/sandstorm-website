...
a document. This "activity event" API was designed by Kenton Varda and its visual elements were
designed by Néna Nguyễn, and any app within Sandstorm can use it, The easiest way to try it out is
to make a new Etherpad document, then open it in an incognito window, and use the incognito window
to leave yourself a comment.
